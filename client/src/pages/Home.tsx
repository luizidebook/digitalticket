...
import { CalendarDays, ChevronRight, CircleDollarSign, LayoutDashboard, LogOut, QrCode, Ticket, Users, Zap } from "lucide-react";

const navItems = [
  { label: "Visão geral", icon: LayoutDashboard, active: true },
  { label: "Eventos", icon: CalendarDays },
  { label: "Pedidos", icon: Ticket },
